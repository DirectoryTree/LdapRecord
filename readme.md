...
- 🔥 **Supercharged ActiveRecord.** Create and modify LDAP obects with ease. All LDAP objects are individual models. Simply modify the attributes on the model and save it to persist the changes to your LDAP server.
